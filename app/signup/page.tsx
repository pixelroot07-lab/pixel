...
export default function SignUpPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    localStorage.setItem('user', JSON.stringify({ name: `${formData.firstName} ${formData.lastName}`, email: formData.email }))
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 dark:from-slate-800 dark:via-blue-900 dark:to-indigo-900 flex items-center justify-center p-4 transition-colors duration-300">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-purple-100 dark:text-slate-300">Join PixelRoot and start managing your utilities</p>
        </div>
